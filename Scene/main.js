class main extends Phaser.Scene {
    ...
    create() {
      this.playButton = this.add.image(640, 360, 'playButton').setInteractive();
      this.galleryButton = this.add.image(1200, 650, 'boutons').setInteractive();
      this.quitButton = this.add.image(640, 460, 'boutons').setInteractive();
